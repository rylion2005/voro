...
public class SynthesisListener implements SpeechSynthesizerListener {
    private static final String TAG = "SynthesisListener";
    ...
    public void onSynthesizeStart(String utteranceId) {
        sendMessage("onSynthesizeStart, utteranceId:" + utteranceId);
    }
    ...
    public void onSynthesizeDataArrived(String utteranceId, byte[] bytes, int progress) {
        //  Log.i(TAG, "SynthesizeProgress, progress：" + progress + ";utteranceId:" + utteranceId );
    }
    ...
    public void onSynthesizeFinish(String utteranceId) {
        sendMessage("onSynthesizeFinish, utteranceId:" + utteranceId);
    }
